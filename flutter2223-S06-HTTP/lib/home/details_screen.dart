...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<bool> verifyGameOwnership(String user_id, String game_id) async {
    ...
    //url
    Uri verifyUri =
        Uri.parse("http://172.16.12.40:9090/library/$user_id/$game_id");
  ...
  Future<bool> buyGame(String user_id, String game_id) async {
    //url
    Uri buyUri = Uri.parse("http://172.17.8.232:9090/library");
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ElevatedButton.icon(
                onPressed: () {
                  verifyGameOwnership("63974c6325784d6ee7ed49b7", args.game.id)
                      .then((isOwned) {
                    if (isOwned) {
                      showDialog(
                        context: context,
                      ...
                      buyGame("63974c6325784d6ee7ed49b7", args.game.id);
                      setState(() {
